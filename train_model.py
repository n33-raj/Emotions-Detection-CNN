...
test_set = test_datagen.flow_from_directory(r'dataset\validation',
                                            target_size = (48,48),
                                            color_mode = "grayscale",
                                            batch_size = 32,
                                            class_mode = "categorical",
...
## Output Layer
cnn.add(layers.Dense(units=7, activation='softmax'))     ## as we have 7 classes of emotions
